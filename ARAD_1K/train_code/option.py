...
parser.add_argument('--outf', type=str, default='./exp/AMDC_3stg', help='saving_path')

# Model specifications
parser.add_argument('--use_adaptive_mask', type=bool, default=True, help='use dynamic mask')
parser.add_argument('--pretrained_mask_path', type=str, default=None, help='pretrained model directory')
parser.add_argument('--method', type=str, default='AMDC_3stg', help='method name')
